            ...
            <div className={styles.boxLogin}>
                <div className={styles.formLoginWrap}>
                    ...
                    <div className={styles.tooltipWrap}>
                        ...
                        <div className={styles.policyWrap}>Bằng cách <span onClick={() => handleRedirectRoute('/register')} className={styles.textActive}>Tạo tài khoản</span> hoặc Đăng nhập, tôi đồng ý với <span className={styles.textActive}>Thỏa thuận sử dụng Dịch vụ</span> và Chính sách Quyền riêng tư của AI Chat .</div>
                    </div>
                </div>
            </div>
        </AuthLayout>
