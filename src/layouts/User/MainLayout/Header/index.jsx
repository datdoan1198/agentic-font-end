                    ...
                    <Popover
                        ...
                        content={
                            <div className={styles.menuInfoWrap}>
                                <div className={`${styles.itemMenu} ${styles.itemMenuActive}`}>
                                    <div className={'w-[25px] flex justify-center'}><InlineSVG src={Robot} width={24}/></div>Chatbots
                                </div>
                                <div className={`${styles.itemMenu}`}>
                                    <div className={'w-[25px] flex justify-center'}><InlineSVG src={User} width={18}/></div>Tài khoản
                                </div>
                                <div className={`${styles.itemMenu}`}>
                                    <div className={'w-[25px] flex justify-center'}><InlineSVG src={Crow} width={18}/></div>Gói dịch vụ

                                </div>
                                <div
                                    className={`${styles.itemMenu} ${styles.btnLogout}`}
                                    onClick={() => handleLogout()}
                                >
                                    <div className={'w-[25px] flex justify-center'}><InlineSVG src={Logout} width={18}/></div>Đăng xuất
                                </div>
                            </div>
                        }
                        trigger="hover"
