                    ...
                    <div className={`${styles.boxLayoutChat} ${isShowFormChat && styles.boxLayoutChatShow}`}>
                        ...
                        <div className={styles.messageWrap}>
                            ...
                            {messages && messages.length > 0 ? (
                                ...
                                <div className={styles.itemMessage}>
                                    ...
                                    <div className={`${styles.contextWrap}`}>
                                        <div className={styles.contextItem}>Xin chào, mình là trợ lý ảo
                                            của {bot?.business?.name}👋
                                        </div>
                        ...
                        <div className={styles.actionWrap}>
                            ...
                            <div className={styles.introduceWrap}>
                                <div className={styles.description}>Đối tác triển khai ứng dụng AI hàng đầu cho doanh
                                    nghiệp
                                </div>
